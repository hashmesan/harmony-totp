...
class SmartVault {
    ...
    getOTPSecret() {
        ...
        this.walletData = Object.assign(this.walletData, {secret: secret,  salt: bin.readUIntLE(0, 6)})
    }
    ...
    async recoverWallet(name, codes, fStatus) {
        ...
        fStatus && fStatus(`Wallet owned by ${info.owner} hashStorageId=${info.hashStorageID}`);
        ...
        fStatus && fStatus(`Generated proof(${proof.length})`);

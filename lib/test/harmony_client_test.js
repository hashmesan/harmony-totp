...
describe("Library test", (accounts) => {
  ...
  it("checks for erc20 metas", async () => {
  ...
  it.only("checks for smartvault info metas", async () => {
    var v2_address = "0x50303922A5e941C71124E445de65bB95438d49D7";

    var client = new HarmonyClient("https://api.s0.t.hmny.io", "0x4fb1C434101ced0773a3bc77D541B3465023639f");
    var res = await client.getSmartVaultInfo(v2_address);
    console.log(res);
  });
});

      ...
      <SmartVaultConsumer>
        {({ smartvault }) => (
          <React.Fragment>
            ...
            <h5 className="mt-4">
              A short, memorable name makes it easy find your wallet, and share
              with others.
            </h5>
              ...
              <div className="mt-4">
                <form className="form text-left" style={{ maxWidth: 500 }}>
                  <div className="form-group mr-3">
                    <label htmlFor="exampleInputEmail1">Choose a name</label>
                    <div className="input-group">
                      ...
                      <small id="emailHelp" className="form-text text-muted">
                        Subject to availability and pricing based on number of
                        characters.
                      </small>
                    </div>
                  </div>
                  <div className="form-group mr-3">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        onChange={this.handleDailyLimit.bind(this)}
                      />
                      <div className="input-group-append">
                        <span className="input-group-text" id="basic-addon2">
                          ONE
                  ...
                  <div className="form-group mr-3">
                    <label htmlFor="exampleInputEmail1">
                      Set Drain Address (optional)
                    </label>
                    <div className="input-group">
                      <input
                        type="text"
                        className="form-control"
                        value={this.state.drainAddress}
                        onChange={this.handleDrainChange.bind(this)}
                      />
                      <small id="emailHelp" className="form-text text-muted">
                        The last resort to recover your funds by sending 1.0 ONE
                        originating from the recovery address. It is IMPORTANT
                        you do not use exchange wallet which may change address.
                      </small>
                    </div>
                  </div>
                </form>
            ...
            <div className="collapse" id="collapseExample">
              <img
                src="https://miro.medium.com/max/506/1*y_GmTrFyrWG6ZP8o7docUA.png"
                width="500"
            ...
            {this.state.showCost && (
              <div className="mt-4">
                ...
                <div>
                  ...
                  >
                    Register for{" "}
                    {web3utils.fromWei(this.state.cost).split(".")[0]} ONE
                  </button>
                </div>
              </div>
            )}

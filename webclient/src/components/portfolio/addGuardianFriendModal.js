      ...
      <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <nav className="nav nav-pills nav-justified mx-n3" id="tabContent">
              <a
                id="guardiansTab"
...
export default connect(mapToProps, actions)(addGuardianFriendModal);

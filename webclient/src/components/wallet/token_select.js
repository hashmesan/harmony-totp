...
export const default_list = "https://d1xrz6ki9z98vb.cloudfront.net/venomswap/lists/venomswap-default.tokenlist.json";
		...
		axios.get(default_list).then(e => {
			const tokens = e.data.tokens.filter(e => {
				if (nextProps.networkId == "1666600000") {
					...
					return e.chainId == nextProps.networkId;
				}
			});
						...
						<div className="modal-body p-0">
							<div className="btn-group-vertical w-100">
								{this.state.tokens && [NativeToken, ...this.state.tokens].map(e => {
									return <button class="btn btn-block btn-light text-left" onClick={(ev) => this.props.chooseToken(e)}>

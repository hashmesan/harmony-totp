...
class WalletInfo extends Component {
    constructor(props) {
        super(props)
        this.state = {}
        this.client = new HarmonyClient(CONFIG[props.environment].RPC_URL, CONFIG[props.environment].ENS_ADDRESS)
    }
        ...
        return (
            ...
            <div className="card">
                <div className="card-header text-center" id="headingOne">
                    <a  data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Wallet Info</a>
                </div>
                ...
                <div className="card-body">
                    ...
                    <div className="text-center">
                        ...
                        <tbody>
                            <tr>
                                <td>OTP Tokens</td>
                                <td>{this.state.data.counter} / {Math.pow(2, parseInt(this.state.data.merkelHeight))}</td>
                            </tr>
                            <tr>
                                <td># of Guardians</td>
                            ...
                            <tr>
                                ...
                                <td>{this.state.data.hashStorageID.startsWith("Q") ? "YES": "NO"}</td>
                            </tr>                                                        
                        </tbody>
                        </table>
                    </div>

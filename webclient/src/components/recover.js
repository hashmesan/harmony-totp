...
class RecoverPage extends Component {
  ...
  render() {
    return (
      <div
        className="container text-center pt-5 justify-content-md-center pb-5"
        style={{ maxWidth: 960 }}
      >
        <AccountProvider>
          <Router>
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <h5 className="mt-4">
          Recovering your requires your wallet name, and access to your Google
          Authenticator.
        </h5>
        <Link className="mt-5 btn btn-lg btn-primary" to="/recover/step1">
          Start
        </Link>
        <div className="mt-4">
